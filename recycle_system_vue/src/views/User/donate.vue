...
<!--    <div class="demonstration"><div style="position: relative;top: 15px;">物资捐赠</div></div>-->
    <div style="margin-top: 20px;">
      <div style="height: 550px;width:50%;float:left;padding-left: 0px;display: inline-block;position: relative;left:-12px;"  class="foods-wrapper" ref="foodsWrapper">
        ...
        <div>
          ...
          <el-select style="width: 400px;margin-left: 3px;" v-model="form.addressId"  clearable placeholder="请选择捐赠地点">
            <el-option
